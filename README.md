...
| 5 | CycleGAN | 肖像画を入力し、写真画像を生成 <br /><br />上段: 肖像画 <br>下段: 写真画像 | ![0089](https://user-images.githubusercontent.com/20309500/107369273-eb8fda00-6b24-11eb-9e5b-623f1666403f.png) |
...
| ページ | 誤 | 正 | 補足 |
|:-----------|:------------|:------------|:------------|
| 3章 p52 1行目 | パラメータを待つモデル分布 | パラメータを持つモデル分布| 誤字  |
