...
| 章 | モデル |説明| 生成画像 |
|:--|:---------|:------------|:------------------------------------------|
| 3 | DCGAN |ノイズからサイズ128×128の猫カラー画像を生成 | <img width="600" alt="fake_cat" src="https://user-images.githubusercontent.com/40778791/107382141-e8034f80-6b32-11eb-8029-563864814cfd.png"> |
| 4 | xx | xx |xx |xx|
